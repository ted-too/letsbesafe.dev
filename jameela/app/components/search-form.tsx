    ...
    <>
      {firstSearch ? (
        <p className="text-center sm:text-lg mb-6 mt-[15vh] text-light">
          Download and save your youtube videos in a <br /> format of your
          choice
        </p>
      ) : (
        <span className="text-center sm:text-lg mb-6 mt-[5vh] text-light">
      ...
      <div className="relative w-full max-w-7xl transition-opacity">
        {children}
      </div>
    </>
  );
...
export const ErrorBoundary: ErrorBoundaryComponent = ({ error }) => {
  return (
    <div className="mt-[10vh] mx-6 w-full sm:max-w-xl max-w-3xl bg-pink-50 border border-pink-400 text-normal rounded-lg p-10 pb-14 sm:pb-28 flex flex-col items-center">
      <svg
        className="w-auto h-12 sm:h-24 mb-6"
        viewBox="0 0 14 15"
        fill="none"
      ...
      <span className="text-2xl sm:text-3xl text-center font-semibold">
        Oh no!
      </span>
      <span className="text-lg sm:text-xl text-center font-light">
